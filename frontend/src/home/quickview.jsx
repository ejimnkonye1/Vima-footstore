...
<div className="flex flex-col sm:flex-row space-x-0 sm:space-x-4">
  <button
    onClick={addtoCart}
    className="flex-1 bg-indigo-600 text-white py-3 px-6 rounded-md hover:bg-indigo-700 font-medium transition duration-200 ease-in-out flex items-center justify-center"
    disabled={loading}
  >
    {loading ? (
      <>
